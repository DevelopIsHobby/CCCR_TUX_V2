...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user = User.builder()
                ...
                .profilePictureUrl("home/user/upload/default/관리자님.jpg")
                .build();
        User user1 = User.builder()
                .email("user1@com.chattest")
                .name("김민석")
                .password(passwordEncoder.encode("1234"))
                .profilePictureUrl("home/user/upload/default/카카오톡_프사.jpg")
                .build();
        User user2 = User.builder()
                .email("user2@com.chattest")
                .name("최민정")
                .password(passwordEncoder.encode("1234"))
                .profilePictureUrl("home/user/upload/default/민정님.jpg")
                .build();
        User user3 = User.builder()
                .email("user3@com.chattest")
                .name("윤남석")
                .password(passwordEncoder.encode("1234"))
                .profilePictureUrl("home/user/upload/default/남석진우뉨.jpg")
                .build();
