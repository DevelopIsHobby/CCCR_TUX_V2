...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user = User.builder()
                ...
                .profilePictureUrl("/app/upload/관리자님.jpg")
                .build();
        User user1 = User.builder()
                .email("user1@com.chattest")
                .name("김민석")
                .password(passwordEncoder.encode("1234"))
                .profilePictureUrl("/app/upload/카카오톡_프사.jpg")
                .build();
        User user2 = User.builder()
                .email("user2@com.chattest")
                .name("최민정")
                .password(passwordEncoder.encode("1234"))
                .profilePictureUrl("/app/upload/민정님.jpg")
                .build();
        User user3 = User.builder()
                .email("user3@com.chattest")
                .name("윤남석")
                .password(passwordEncoder.encode("1234"))
                .profilePictureUrl("/app/upload/남석진우뉨.jpg")
                .build();
